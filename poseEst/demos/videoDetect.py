...
cap = cv2.VideoCapture(
    '/home/nandwalritik/poseEstimator/poseEst/TestSamples/inputs/Harshav_Tad.mp4')
...
out = cv2.VideoWriter(
    '/home/nandwalritik/poseEstimator/poseEst/TestSamples/outputs/test2.mp4', fourcc, 20, size)
while(cap.isOpened()):
    ret, frame = cap.read()
    if(ret == True):
